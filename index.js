...
const payloadParser_0 = new Parser()
	...
	.floatbe('L1Current', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L2Current', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L3Current', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('TotalActivePower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L1ActivePower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L2ActivePower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L3ActivePower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('TotalReactivePower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L1ReactivePower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L2ReactivePower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L3ReactivePower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('TotalApparentPower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L1ApparentPower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L2ApparentPower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L3ApparentPower', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('TotalPowerFactor', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L1PowerFactor', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L2PowerFactor', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	.floatbe('L3PowerFactor', { formatter: (x) => { return parseFloat(x.toFixed(3)); } })
	;
